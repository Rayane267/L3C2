...
namespace Characters
{
    ...
    public enum CharClass : byte { GUERRIER, VOLEUR, ARCHER, MAGE, SOIGNEUR, ENVOUTEUR, VALKYRIE, DRUIDE };// edited by Mengqian Xu L3C2
    ...
    public class CharsDB
    {
        ...
        public static void initCharsDB() 
        {
            ...
            list.Add(new CharacterDB(17, 3, 3, 7, new Attack(1, 0, true, false, false, AttackEffect.DAMAGE, 2), new Attack(1, 0, true, false, false, AttackEffect.DAMAGE, 3), new Attack(1, 0, true, false, false, AttackEffect.DAMAGE, 2))); // GUERRIER 
            ...
            list.Add(new CharacterDB(13, 2, 3, 5, new Attack(7, 0, true, false, false, AttackEffect.DAMAGE, 2), new Attack(10, 0, true, false, false, AttackEffect.DAMAGE, 4), new Attack(12, 2, true, false, false, AttackEffect.DAMAGE, 1))); // ARCHER 
            ...
            list.Add(new CharacterDB(14, 2, 4, 4, new Attack(1, 1, true, false, false, AttackEffect.DAMAGE, 2), new Attack(4, 1, true, false, false, AttackEffect.DAMAGE, 3), new Attack(1, 0, true, false, false, AttackEffect.DAMAGE, 4))); // VALKYRIE 
    ...
    public class Character : System.IEquatable<Character>, System.IComparable<Character>
    {
        ...
        //Constructor
        //Author : ?
        // Edited by L3C2, TALEB Rayane, TAO Zeyu
        public Character(CharClass charClass, int x, int y, int team, int id)
        {
            this.id = id;
        ...
        //Author : ?
        // Edited by L3C2, TALEB Rayane, Mengqian Xu
