        ...
        public Point planForAttack(CharacterCPU target, ActionType action)
        {
            ...
            switch (action)
            {
                ...
                case ActionType.SKILL2:
                    ...
                    if (this.Character.getName() == "GUERRIER" && TotalDamage2 >= 22) TotalDamage2 -= 22;
                    else TotalDamage2 -= 16;
            ...
            if (attack.rangeAoE > 0)
            {
                ...
                if (this.Character.getName() == "GUERRIER" && TotalDamage2 >= 22)
                {
                    TotalDamage2 -= 22;
                    Skill2Available = true;
                }
                else if (TotalDamage2 >= 16)
                {
                    TotalDamage2 -= 16;
                    Skill2Available = true;
                }
